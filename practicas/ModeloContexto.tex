...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \textsf{\textbf{\large UN SISTEMA BASADO EN CONOCIMIENTO PARA \ldots(LA PLANIFICACIÓN Y ENTRENAMIENTO DEL KARATE)\\[1.5cm]
        ...
        \subsection{Formulario OM-1: contexto organizacional, problemas y soluciones.}
            ...
            \begin{table}[H]
                ...
                \begin{tabularx}{\textwidth}{|l|X|} \hline
                    ...
                    \begin{enumerate}
                        \item Planificar entrenamientos de kárate para que los alumnos puedan entrenar de manera eficiente.
            ...
            \scriptsize
                \begin{tabularx}{\textwidth}{|l|X|} \hline
                    ...
                    \begin{itemize}
                        ...
                        \item \textbf{Conocimiento relación}: entre indicadores fisicos y ejercicios
        ...
        \begin{table}[H]
            ...
            \begin{tabularx}{\textwidth}{|l|X|} \hline
                ...
                \item¿Cuáles son los beneficios esperados para la organización con la adopción de la solución? Se deben identificar los beneficios tanto económicos como intangibles.
                  En cuanto a los beneficios económicos, el uso del SBC para la planificación nos permitirá reducir la cantidad de tiempo, o prescindir de la necesidad de empleados para estas tareas
